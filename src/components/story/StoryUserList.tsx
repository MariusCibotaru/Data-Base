...
import { fetchUserStories, createStory } from '../../redux/slices/Story';
...
const StoryUserList = () => {
    ...
    const userStories = useSelector((state: RootState) => state.stories.userStories);
    ...
    useEffect(() => {
        if (isAuthenticated && currentUser?.Id) {
            dispatch(fetchUserStories(currentUser.Id));
        }
        ...
        <Box display="flex" justifyContent="center" flexWrap="wrap" gap={2}>
            ...
            <Box display="flex" flexDirection="column" alignItems="center" justifyContent="center">
                ...
                <Box display="flex" justifyContent="center" flexWrap="wrap" gap={2}>
                    ...
                    <StoryDialog
                        story={selectedStoryIndex !== null ? userStories[selectedStoryIndex] : null}
